  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Sonu - Revolutionizing transportation with convenience and efficiency. Find, book, and track your ride in real-time, catering to your diverse needs with a seamless experience."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Sonu - Revolutionizing transportation with convenience and efficiency. Find, book, and track your ride in real-time, catering to your diverse needs with a seamless experience.`}
            </Text>
            <Box
